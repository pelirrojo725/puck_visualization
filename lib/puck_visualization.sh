#!/bin/bash
if [ -d /home/samuel/Desktop/Projects/puck_visualization ]; then
	export PUCK_ROOT=/home/samuel/Desktop/Projects/puck_visualization/lib
fi
...
python3 ${PUCK_ROOT}/crop_images.py $1 $tmp_dir $fbase

echo Testing Positions:
python3 ${PUCK_ROOT}/predict_position.py ${PUCK_ROOT} ${tmp_dir} ${fbase}
