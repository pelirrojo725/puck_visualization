...
if [ -d /Users/samuel/Desktop/Projects/puck_visualization ]; then
    export PUCK_ROOT=/Users/samuel/Desktop/Projects/puck_visualization/lib
    source ${PUCK_ROOT}/venv/bin/activate
fi
...
for i in {1..16}; do
    ...
    cp ${tmp_dir}/${fbase}_${i}.jpg /Users/samuel/Desktop/Test/
done
